...
def set_geography(cb, geography, static=False, pop_scale=1):
    ...
    if pop_scale != 1:
        cb.set_param('x_Base_Population', pop_scale * cb.get_param('x_Base_Population'))
...
geographies = {
    ...
    "Household": {"Geography": "Household",
                  "Custom_Individual_Events": ["VaccinateNeighbors", "Blackout", "Distributing_AntimalariaDrug", 'TestedPositive',
