...
class ModFn(object):
    def __init__(self, func, *args, **kwargs):
        self.func = func
        # self.fname = self.func.__name__       # [TODO]: zdu: param_update defined in IterationState has no __name__
        self.args = args
        self.kwargs = kwargs
    ...
    def __call__(self, simulation):
        ...
        # ModBuilder.metadata.update(md)          # [TODO]: zdu: we may not need this!
