...
from itertool.utilities.LocalOS import LocalOS
...
def set_habitat_multipliers(cb, demog_name,
    ...
    nodes = []
    if not NodesMultipliers_list:
        NodesMultipliers_list = [NodesMultipliers(
        nodes=[326436567],
        multipliers=[{"Factor": 1, "Habitat": "ALL_HABITATS", "Species": "ALL_SPECIES"}])]
