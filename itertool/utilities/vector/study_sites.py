from .species import set_larval_habitat, set_species_param, scale_all_habitats, set_species
...
def configure_rafin_marke(cb):
    set_species(cb, ["arabiensis", "gambiae"])
...
def configure_dapelogo(cb):
    set_species(cb, ["funestus", "gambiae"])
...
def configure_nabang(cb):
    set_species(cb, ["maculatus", "minimus"])
