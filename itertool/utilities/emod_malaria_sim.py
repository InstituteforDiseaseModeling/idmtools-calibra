...
class EMODMalariaSim(IEMODDefault):
    ...
    def demographics() -> Dict:
        return {
            "birth_cohort_demographics.compiled.json": {
                "Metadata": {
                    "Author": "jsteinkraus",
                ...
                "StringTable": {
                    ...
                    "AgeDistribution1": "ab",
                    "AgeDistribution2": "ac",
                    "AgeDistributionFlag": "ad",
                    "ImmunityDistribution1": "ae",
                    "ImmunityDistribution2": "af",
                    "ImmunityDistributionFlag": "ag",
                    "MigrationHeterogeneityDistribution1": "ah",
                    "MigrationHeterogeneityDistribution2": "ai",
                    "MigrationHeterogeneityDistributionFlag": "aj",
                    "MortalityDistribution": "ak",
                    "AxisNames": "al",
                    "AxisScaleFactors": "am",
                    "AxisUnits": "an",
                    "NumDistributionAxes": "ao",
                    "NumPopulationGroups": "ap",
                    "PopulationGroups": "aq",
                    "ResultScaleFactor": "ar",
                    "ResultUnits": "as",
                    "ResultValues": "at",
                    "PrevalenceDistribution1": "au",
                    "PrevalenceDistribution2": "av",
                    "PrevalenceDistributionFlag": "aw",
                    "RiskDistribution1": "ax",
                    "RiskDistribution2": "ay",
                    "RiskDistributionFlag": "az",
                    "NodeAttributes": "ba",
                    "AbovePoverty": "bb",
                    "Airport": "bc",
                    "Altitude": "bd",
                    "BirthRate": "be",
                    "InitialPopulation": "bf",
                    "Latitude": "bg",
                    "Longitude": "bh",
                    "Region": "bi",
                    "Seaport": "bj",
                ...
                "Nodes": [
                    {
                        "aa": {
                            ...
                            "ak": {
                                ...
                                "ar": 2.74e-06,
                                "as": "annual deaths per 1000 individuals",
                                "at": [
                                    [
                                        45
                                    ],
