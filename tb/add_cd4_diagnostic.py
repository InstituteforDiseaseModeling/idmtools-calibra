def add_cd4_diagnostic(task, trigger_treatment_list, event_200='Below200', event_350='Below350', event_500='Below500',
                       event_above_500='Above500', start_day=0,
    ...
    task.config.parameters.Listed_Events = existing_event_list
