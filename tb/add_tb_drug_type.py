...
def add_tb_drug_type(task, drug_name, duration, cure_proportion, death_proportion,
    ...
    total_rate = converttorate(cure_proportion + inactivation_proportion +death_proportion + relapse_proportion, duration)
    ...
    drug_dict = {drug_name: dict(TB_Drug_Cure_Rate= rate_cure, TB_Drug_Cure_Rate_MDR= rate_curemdr,
                               ...
                               TB_Drug_Inactivation_Rate_MDR= rate_inactivationmdr, TB_Drug_Inactivation_Rate_HIV= rate_inactivationhiv,
