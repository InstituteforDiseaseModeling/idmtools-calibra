def add_bcg(task, trigger_treatment_list, initial_efficacy, vaccine_take=1, age_take_decay=1.0, box_duration=365,
            immune_decay=3650, start_day=0, duration=-1, property_restrictions_list=[], nodeIDs=[],
