def add_smear_diagnostic(task, trigger_treatment_list, base_sensitivity_smearpos, base_sensitivity_smearneg,
                         pos_event='TestPositiveOnSmear', treatment_fraction=1,
