...
from idmtools_calibra.algorithms.pbnb.c_sub_region import cSubRegion
...
class OptimToolPBnBPlotter(BasePlotter):
    ...
    def visualize(self, iteration_state):
        ...
        for c_subr in self.npt['l_subr']:
            ...
            c_subr_set.pd_sample_record = pd.DataFrame.from_dict(self.npt['l_subr'][c_subr]['pd_sample_record'],
                                                                 orient='columns')
    ...
    def visualize_results(self):
        ...
        fig.legend((p_min, p_max), (
            'minimum point:[' + str(l_min_coordinate[0]) + ',' + str(l_min_coordinate[1]) + '], result:' + str(
                f_min_value),
