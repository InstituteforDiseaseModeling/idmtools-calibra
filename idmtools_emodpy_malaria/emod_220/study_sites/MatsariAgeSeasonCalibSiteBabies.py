...
class MatsariAgeSeasonCalibSiteBabies(DensityCalibSite):
    metadata = {
    ...
    def get_reference_data(self, reference_type):
        super(MatsariAgeSeasonCalibSiteBabies, self).get_reference_data(reference_type)
    ...
    def get_setup_functions(self):
        setup_fns = super(MatsariAgeSeasonCalibSiteBabies, self).get_setup_functions()
        ...
        setup_fns.append(lambda cb: cb.update_params({'Demographics_Filenames': ['Calibration\\birth_cohort_demographics_babies.json'],
    ...
    def __init__(self):
        super(MatsariAgeSeasonCalibSiteBabies, self).__init__('Matsari_babies')
