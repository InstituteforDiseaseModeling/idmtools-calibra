...
class RafinMarkeAgeDateSite(DensityCalibSite):
    metadata = {
    ...
    def get_reference_data(self, reference_type):
        super(RafinMarkeAgeDateSite, self).get_reference_data(reference_type)
    ...
    def get_setup_functions(self):
        setup_fns = super(RafinMarkeAgeDateSite, self).get_setup_functions()

        return setup_fns

    def __init__(self):
        super(RafinMarkeAgeDateSite, self).__init__('Rafin_Marke')
