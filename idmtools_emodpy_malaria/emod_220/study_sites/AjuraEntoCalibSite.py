...
# TODO locate ChannelByMultiYearSeasonCohortAnalyzer
class AjuraEntoCalibSite(EntomologyCalibSite):
    ...
    def get_analyzers(self):
        return [ChannelByMultiYearSeasonCohortAnalyzer(site=self, seasons=self.metadata['months'], duration=self.duration,
