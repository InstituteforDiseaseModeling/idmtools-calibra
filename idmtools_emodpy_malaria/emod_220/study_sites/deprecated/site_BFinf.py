...
def get_setup_functions(site):
    ...
    setup_functions.append(lambda cb: cb.update_params(
        {"Demographics_Filenames": ['Burkina/Burkina/Burkina Faso_' + site + '_2.5arcmin_demographics.static.compiled.json']}))
