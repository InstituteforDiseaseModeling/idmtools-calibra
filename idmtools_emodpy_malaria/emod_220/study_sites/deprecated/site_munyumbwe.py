...
setup_functions = [config_setup_fn(duration=sim_duration),
                   ...
                   add_treatment_fn(start=365 * (burn_years - 5),
                                    targets=[{'trigger': 'NewClinicalCase', 'coverage': 1, 'agemin': 15, 'agemax': 200, 'seek': 0.3,
                                              'rate': 0.3},
...
analyzers = {
    ...
    'PositiveFractionByDistanceAnalyzer': {
        "distmat": "C:/Users/jgerardin/work/households_as_nodes/munyumbwe_filled_all_r1_distance_matrix.csv",
