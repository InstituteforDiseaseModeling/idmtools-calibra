...
round_days = [365 * burn_years + x * 60 + msat_day - msat_offset for x in range(3)] + [
...
analyzers = {
    ...
    'PositiveFractionByDistanceAnalyzer': {
        "distmat": "C:/Users/jgerardin/work/households_as_nodes/luumbo_filled_all_r1_distance_matrix.csv",
