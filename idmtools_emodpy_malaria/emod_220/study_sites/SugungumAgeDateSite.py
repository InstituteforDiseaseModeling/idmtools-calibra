...
class SugungumAgeDateSite(DensityCalibSite):
    metadata = {
    ...
    def get_reference_data(self, reference_type):
        super(SugungumAgeDateSite, self).get_reference_data(reference_type)
    ...
    def get_setup_functions(self):
        setup_fns = super(SugungumAgeDateSite, self).get_setup_functions()

        return setup_fns

    def __init__(self):
        super(SugungumAgeDateSite, self).__init__('Sugungum')
