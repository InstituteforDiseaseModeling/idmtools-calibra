...
emod_sir_example_dir = os.path.join(CURRENT_DIR, "../../..", "examples", "emod_sir", "OutputOption1")
ep4=os.path.join(emod_sir_example_dir, "EP4")
REFERENCE_DATA_DIR= os.path.join(emod_sir_example_dir, 'reference')
