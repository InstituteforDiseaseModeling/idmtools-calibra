...
from itertool.utilities.builders.TemplateHelper import TemplateHelper
from itertool.utilities.builders.ConfigTemplate import ConfigTemplate
from itertool.utilities.builders.TaggedTemplate import CampaignTemplate
from itertool.utilities.builders.TaggedTemplate import DemographicsTemplate
...
task = EMODTask.from_default(eradication_path=exe_path)
...
def map_sample_to_model_input(simulation, sample):
    ...
    return templates.mod_dynamic_parameters(simulation, table)
...
separatrix = Separatrix_BHM(params,
                            ...
                            # <-- This is the success probability isocline that we seek to identify
                            num_past_iterations_to_include_in_metamodel=-1,
                            ...
                            # <-- Number of samples per iteration.  Actual number of sims run is this number times number of sites.
                            samples_final_iteration=64,
                            # <-- Number of samples for the final iteration.  Actual number of sims run is this number times number of sites.
